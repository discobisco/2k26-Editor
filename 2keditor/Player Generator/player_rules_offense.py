...
_TENDENCY_RECIPES: dict[str, tuple[_Recipe, ...]] = {
    ...
    "SPOTUPDRIVE": (_Recipe("spot_up_drive", (("derived.rim_attempt_rate", 0.30), ("derived.foul_pressure", 0.25), ("derived.unassisted_two_rate", -0.20), ("role.wing", 0.25)), "spot-up drive events", "rim/foul pressure from a non-primary-creation wing context", "spot-up drives are behavior frequency"), _Recipe("historical_spot_up_drive", (("derived.foul_pressure", 0.25), ("derived.attempt_share", 0.20), ("role.wing", 0.35), ("role.post", -0.20)), "spot-up and assisted-shot events", "drive pressure and scoring responsibility allocated through continuous wing-versus-post role", "post scoring cannot become a spot-up perimeter drive without wing participation")),
