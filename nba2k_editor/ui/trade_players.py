    ...
    with dpg.child_window(tag="screen_trade", parent=app.content_root, autosize_x=True, autosize_y=True, show=False) as tag:
        ...
        with dpg.group(horizontal=True):
            ...
            app.trade_add_team_combo_tag = dpg.add_combo(
                ...
                width=220,
                callback=lambda _sender, value: app._trade_add_participant(value),
            )
            ...
            dpg.add_spacer(width=10)
            dpg.add_button(label="Trade Players", width=140, callback=lambda: app._trade_open_player_modal())
        ...
        with dpg.group(horizontal=True):
            ...
            dpg.add_button(label="Clear Slot", width=100, callback=lambda: app._trade_clear_slot())
        ...
        with dpg.group(horizontal=True):
            dpg.add_button(label="Propose Trade", width=140, callback=lambda: app._trade_propose())
            dpg.add_button(label="Clear Packages", width=140, callback=lambda: app._trade_clear())
