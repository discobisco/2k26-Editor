...
class PlayerGeneratorDisplayTests(unittest.TestCase):
    ...
    def test_import_facade_calls_existing_game_port_import(self) -> None:
        ...
        calls: list[tuple[Any, Any, str | None, bool]] = []

        def fake_import(model: object, contract: object, *, team_filter: str | None = None, match_existing_player_names: bool = False) -> object:
            calls.append((model, contract, team_filter, match_existing_player_names))
        ...
        called_model, contract, team_filter, match_existing_player_names = calls[0]
    ...
    def test_import_facade_can_request_existing_player_name_matching(self) -> None:
        ...
        def fake_import(model: object, contract: object, *, team_filter: str | None = None, match_existing_player_names: bool = False) -> object:
            calls.append(match_existing_player_names)
            return SimpleNamespace(apply_result=SimpleNamespace(applied_players=2, generated_count=2, succeeded=350, failed=0))
